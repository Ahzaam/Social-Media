      ...
      <div class="chat_container offset-lg-4 col-lg-4 col-md-12 " id="chat" style="overflow-y:scroll; overflow-x:hidden;">
          ...
          if($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
              ...
              echo "
              <div  class='chats'>
                <div class='inchat lead reciever'>
                  <div class='thhhe r'>".
                  $row['message'] ."
                </div>
              </div>
        ...
        $(".send").click(function(){
            ...
            if(message != ""){
              ...
              function(data, status){
                ...
                document.getElementById('chat').innerHTML += "<div  class='chats'><div class='inchat lead sender'><div class='thhhe s'>" + message + "</div></div> </div>";
          ...
          $.ajax({
            ...
            success: function(data, status){
              if(data != ""){
                let chat = $('#chat').html();
                console.log(data);
                message = "<div  class='chats'><div class='inchat lead reciever'><div class='thhhe r'>"+data +"\n</div>\n</div>\n</div>";
                console.log(message);
